...
# 1.1.1.6 Ensure mounting of udf filesytems is disabled (Automated)
rule-1.1.1.6()
{
...
# 1.1.6 Ensure /dev/shm is configured (Manual | Benchmark Automated)
rule-1.1.6()
{
    local banner="Ensure /dev/shm is configured"
    print_rule_banner ${banner}
    print_manual_req_msg ${banner}
}
...
# 1.1.10 Ensure separate partition exists for /var (Manual | Benchmark Automated)
rule-1.1.10()
{
...
# 1.1.11 Ensure separate partition exists for /var/tmp (Manual | Benchmark Automated)
rule-1.1.11()
{
...
# 1.1.15 Ensure separate partition exists for /var/log (Manual | Benchmark Automated)
rule-1.1.15()
{
...
# 1.1.16 Ensure separate partition exists for /var/log/audit (Manual | Benchmark Automated)
rule-1.1.16()
{
...
# 1.1.17 Ensure separate partition exists for /home (Manual | Benchmark Automated)
rule-1.1.17()
{
...
#1.1.19-1.1.21 are manual on benchmark (removable media related)
...
#1.1.22 Ensure sticky bit on world-writable directories (Automated)
rule-1.1.22()
{
...
# 1.10 Ensure GDM login banner is configured (Automated)
rule-1.10()
{
    local conftext="banner-message-enable=true\nbanner-message-text='Authorized uses only. All activity may be monitored and reported.'"
    local conffile="/etc/gdm3/greeter.dconf-defaults"
    print_rule_banner "Ensure GDM is removed or login is configured"
...
{
    local -A rulehash
    local common="1.1.1.1 1.1.1.2 1.1.1.3 1.1.1.4 1.1.1.5 1.1.1.6 1.1.2 1.1.3\
        1.1.4 1.1.5 1.1.6 1.1.7 1.1.8 1.1.9 1.1.12 1.1.13 1.1.14 1.1.18 1.1.19\
        1.1.20 1.1.21 1.1.22 1.2.1 1.2.2 1.3.1 1.3.2 1.3.3 1.4.1 1.4.2 1.5.1\
        1.5.2 1.5.3 1.6.1 1.6.2 1.6.3 1.6.4 1.7.1.1 1.7.1.2 1.7.1.3 1.8.1.1\
        1.8.1.2 1.8.1.3 1.8.1.4 1.8.1.5 1.8.1.6 1.9 1.10"
    rulehash[lvl1_server]="$common"" 1.1.23 1.1.24"
    rulehash[lvl2_server]="${rulehash[lvl1_server]}"" 1.1.1.7 1.1.10 1.1.11\
        1.1.15 1.1.16 1.1.17 1.7.1.4"
    rulehash[lvl1_workstation]="$common"
    rulehash[lvl2_workstation]="${rulehash[lvl1_workstation]}"" 1.1.1.7 1.1.10\
        1.1.11 1.1.15 1.1.16 1.1.17 1.1.23 1.1.24 1.7.1.4"
