...
# 2.2.4 Ensure CUPS is not enabled (Automated)
rule-2.2.4()
{
    print_rule_banner "Ensure CUPS is not enabled"
    systemctl --now disable cups
}

# 2.2.5 Ensure DHCP Server is not enabled (Automated)
rule-2.2.5()
{
    print_rule_banner "Ensure DHCP Server is not enabled"
...
rule-2.2.6()
{
    print_rule_banner "Ensure LDAP server is not enabled"
    systemctl --now disable slapd
}

# 2.2.7 Ensure NFS and RPC are not enabled (Automated)
rule-2.2.7()
{
    print_rule_banner "Ensure NFS and RPC are not enabled"
    systemctl --now disable nfs-server
    systemctl --now disable rpcbind
}

# 2.2.8 Ensure DNS Server is not enabled (Automated)
rule-2.2.8()
{
    print_rule_banner "Ensure DNS Server is not enabled"
    systemctl --now disable bind9
}

# 2.2.9 Ensure FTP Server is not enabled (Automated)
rule-2.2.9()
{
    print_rule_banner "Ensure FTP Server is not enabled"
    systemctl --now disable vsftpd
}

# 2.2.10 Ensure HTTP server is not enabled (Automated)
rule-2.2.10()
{
    print_rule_banner "Ensure HTTP server is not enabled"
    systemctl --now disable apache2
}

# 2.2.11 Ensure email services are not enabled (Automated)
rule-2.2.11()
{
    print_rule_banner "Ensure email services are not enabled"
    systemctl --now disable dovecot
}

# 2.2.12 Ensure Samba is not enabled (Automated)
rule-2.2.12()
{
    print_rule_banner "Ensure Samba is not enabled"
    systemctl --now disable smbd
}

# 2.2.13 Ensure HTTP Proxy Server is not enabled (Automated)
rule-2.2.13()
{
    print_rule_banner "Ensure HTTP Proxy Server is not enabled"
    systemctl --now disable squid
}

# 2.2.14 Ensure SNMP Server is not enabled (Automated)
rule-2.2.14()
{
    print_rule_banner "Ensure SNMP Server is not enabled"
...
# 2.2.16 Ensure rsync service is not enabled (Automated)
rule-2.2.16()
{
    print_rule_banner "Ensure rsync service is not enabled"
...
rule-2.2.17()
{
    print_rule_banner "Ensure NIS Server is not enabled"
