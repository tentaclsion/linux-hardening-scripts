...
rule-6.2.2()
{
    ...
    print_rule_banner "Ensure no legacy \"+\" entries exist in ${file}"
...
#6.2.7 Ensure root PATH Integrity (Automated - only warns, not fix)
rule-6.2.7()
{
...
#6.2.16 Ensure no duplicate UIDs exist (Automated - only warns, not fix)
rule-6.2.16()
{
...
#6.2.17 Ensure no duplicate GIDs exist (Automated - only warns, not fix)
rule-6.2.17()
{
...
#6.2.18 Ensure no duplicate user names exist (Automated - only warns, not fix)
rule-6.2.18()
{
...
#6.2.19 Ensure no duplicate group names exist (Automated - only warns, not fix)
rule-6.2.19()
{
...
#6.2.20 Ensure shadow group is empty (Automated - only warns, not fix)
rule-6.2.20()
{
