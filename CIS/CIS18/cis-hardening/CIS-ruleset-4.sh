...
rule-4.1.15()
{
    print_rule_banner "Ensure system administrator actions (sudolog) are collected"
    copy_audit_rule
}
...
rule-4.2.3()
{
    print_rule_banner "Ensure permissions on all logfiles are configured"
...
execute_ruleset-4()
{
    ...
    local common="4.2.1.1 4.2.1.2 4.2.1.3 4.2.1.4 4.2.1.5 4.2.1.6\
        4.2.2.1 4.2.2.2 4.2.2.3 4.2.3 4.3"
    ...
    rulehash[lvl2_workstation]="${rulehash[lvl1_workstation]}"" 4.1.1.1\
        4.1.1.2 4.1.1.3 4.1.2.1 4.1.2.2 4.1.2.3 4.1.3 4.1.4 4.1.5 4.1.6 4.1.7\
        4.1.8 4.1.9 4.1.10 4.1.11 4.1.12 4.1.13 4.1.14 4.1.15 4.1.16 4.1.17"
